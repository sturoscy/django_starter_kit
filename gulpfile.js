...
gulp.task('styles-sass', function() {
    ...
    var tasks   = folders.map(function(folder) {
        return gulp.src(['static_dev/sass/' + folder + '/*.scss', '!static_dev/sass/base_theme/**'], 
...
gulp.task('get-sassy', function() {
    gulp.watch('static_dev/css/**/*.css', ['styles-css']);
    gulp.watch(['static_dev/sass/**/*.scss','static_dev/sass/**/**/*.scss','static_dev/sass/**/**/**/*.scss'], ['styles-sass']);
});
